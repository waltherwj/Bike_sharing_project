...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        final_outputs = final_inputs # signals from final output layer (since f(x)=x for output activation)
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        delta_weights_h_o += output_error_term[:,None].dot(hidden_outputs[:,None].T).T
